...
class PermissionDatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['name' => 'view_tasks', 'module' => 'tasks', 'guard_name' => 'web'],
            ['name' => 'create_tasks', 'module' => 'tasks', 'guard_name' => 'web'],
            ['name' => 'sync_tasks', 'module' => 'tasks', 'guard_name' => 'web'],
            ['name' => 'edit_tasks', 'module' => 'tasks', 'guard_name' => 'web'],
        ];
